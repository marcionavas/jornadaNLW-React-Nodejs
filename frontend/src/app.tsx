...
export function App() {
  ...
  const [emailToInvite, setEmailsToInvite] = useState([
    'marcio.navas@navastech.com.br',
    'ti@unipora.edu.br',
    'camila.navas@navastech.com.br'
  ]);
    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="space-y-4">
          ...
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <div className="flex items-center gap-2 flex-1">
              ...
              <input disabled={isGuestsInputOpen} type="text" placeholder="Para onde você vai?" className="bg-transparent text-lg placeholder-bg-zinc-400 outline-none flex-1" />
            </div>


            <div className="flex items-center gap-2">
              <Calendar className="size-5 text-zinc-400" />
              <input disabled={isGuestsInputOpen} type="text" placeholder="Quando?" className="bg-transparent text-lg placeholder-bg-zinc-400 w-40 outline-none" />
            </div>
        ...
        <p className="text-sm text-zinc-500">
          Ao planejar sua viagem pela pann.er você automaticamente concorda <br />
